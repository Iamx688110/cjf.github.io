...
class IAMX():
    ...
    def createPostHtml(self,issue):
        ...
        if '<code class="notranslate">Iamx-html' in post_body:
            post_body = re.sub(r'<code class="notranslate">Iamx-html(.*?)</code>', lambda match: html.unescape(match.group(1)), post_body, flags=re.DOTALL)
...
if os.environ.get('GITHUB_EVENT_NAME')!='schedule':
    ...
    readme=readme+"### Powered by :heart: [Iamx](https://github.com/Iamx688110/cjf.github.io)\r\n"
